...
/*  suppose if somebody else also has to play the game-can they play with same controller?
    ...
    No- so should we have a new gamecontroller everytime - the whole issue is because we have compose the Game game in GameController class
